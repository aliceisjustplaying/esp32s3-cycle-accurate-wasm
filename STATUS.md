...
- [`0008-tiered-cost-vocabulary-and-acceptance-bounds.md`](decisions/0008-tiered-cost-vocabulary-and-acceptance-bounds.md):
...
- [`0009-execute-the-real-rom.md`](decisions/0009-execute-the-real-rom.md):
...
- [`0010-jit-first-engine-real-time-requirement.md`](decisions/0010-jit-first-engine-real-time-requirement.md):
...
([`docs/reviews/2026-08-31-external/`](reviews/2026-08-31-external/RESPONSE.md))
produced decision
[`0012`](decisions/0012-trust-model-and-backend-adapter.md)
...
[0014](decisions/0014-measured-scheduler-and-adapter-contract.md)
