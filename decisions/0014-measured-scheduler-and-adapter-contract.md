...
(`../timing/`) and through measured mode,
...
by decision 0012. (Amended 2026-08-31: "in puck" now reads "in the
program-office repository esp32s3-cycle-accurate-wasm", where this
record lives; see decision 0013's amendment and `PROVENANCE.md`.)
