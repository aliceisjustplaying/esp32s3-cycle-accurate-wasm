...
Cross-lane architectural decisions remain recorded in the project's
decision journal. (Amended 2026-08-31: that journal, originally puck's
`docs/decisions`, moved to the dedicated program-office repository
`esp32s3-cycle-accurate-wasm`, where this record now lives; the puck
branch is a frozen archive. See `PROVENANCE.md`.)
...
receipts live in the program-office repository (see the amendment
above).
